...
public class AutoRun_NPC : MonoBehaviour
{
    ...
    private NavMesh_Build BuildScript;

    [SerializeField] private bool AutoRun = true;   //救助者脱出行動のON/OFF
    ...
    void Start()
    {
        ...
        surface = GameObject.Find("floor");   //NavMeshSurfaceをアタッチしたオブジェクト名
        BuildScript = surface.GetComponent<NavMesh_Build>();   //NavMesh_Buildのスクリプト

...
/// 倒壊ゲージが指定の値になった場合無線を表示するプログラム(あとから配列にする)
    public void EightGauge()
    {
        ...
        Invoke(nameof(EightGauge2), 5f);     //5秒後に消す
    }
    ...
    public void SixGauge()
    {
        ...
        Invoke(nameof(SixGauge2), 5f);       //5秒後に消す
    }
    ...
    public void FourGauge()
    {
        ...
        Invoke(nameof(FourGauge2), 5f);      //5秒後に消す
    }
    ...
    public void TwoGauge()
    {
        ...
        Invoke(nameof(TwoGauge2), 5f);       //5秒後に消す
    }
    ...
    public void OneGauge()
    {
        ...
        Invoke(nameof(OneGauge2), 5f);       //5秒後に消す
    }
